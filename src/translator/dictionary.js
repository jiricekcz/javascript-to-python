...
module.exports.functionRenames.set("Math.max", ["maxJS", [fs.readFileSync(path.join(__dirname, ".//python/maxJS.py"))]]);
module.exports.functionRenames.set("Math.min", ["minJS", [fs.readFileSync(path.join(__dirname, "./python/minJS.py"))]]);
